...
//     $sql = "INSERT INTO products (`id`,`name`, `description`, `image`, `quantity`, `category_ids`, `brutto_price`, `netto_price`, `tax`, `discount`, `created_at`, `modified_at`, `deleted_at`)
//                 VALUES ('0', '$name', '$description', 'https://picsum.photos/250/250', $quantity, $category_id, $brutto_price, $netto_price, $tax, $discount, NULL, NULL, NULL)";
